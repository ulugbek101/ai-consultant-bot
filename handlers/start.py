...
async def cmd_start(message: types.Message, state: FSMContext) -> None:
    ...
    await message.answer(
        "👋 Вас приветствует экспертный офис аудиторской компании "
        "<b>«Prokar Ekspert Audit»</b> и её руководитель "
        "<a href=\"https://t.me/Prokudina_Kristina\">Кристина Прокудина</a>.\n\n"
        "Вы можете обратиться к нам по любым вопросам предпринимательской деятельности, "
        "и мы обязательно постараемся вам помочь.\n\n"
        "Начнём?",
